...
v0.9.79 uses `v0.9.79` and `github.com/retro-trans`. The URL slash has three extra pixels of space on each side so its outline stays distinct.
...
For v0.9.79 the repacked bank is 459,587 bytes inside its 468,320-byte slot.

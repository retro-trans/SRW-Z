...
Ordered exactly as the rawt chunks appear when walking records 0-13.
Each entry: (JP prefix used to verify alignment, English text). The patcher
menu-encodes the English (digits/./:;= become fullwidth - they are control
bytes in the reader) and pads with spaces to the original chunk size.
"""

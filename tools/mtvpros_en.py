# -*- coding: utf-8 -*-
"""English recap narration for DATA/MTV_PROS.BIN rawt chunks.

Ordered as the rawt chunks appear when walking records 0-13. Each entry is
(prefix byte length, SHA1 prefix, English text). The original text is read
from the user's disc and checked by hash, matching patch_mtvpros.py.
"""
...
TEXTS = [(26,
 ...
 (34, 'f737119cd9370032', '\u3000But mankind had not perished.'),
 (42,
  '64e610f16a76c3d7',
 ...
 (38, '8350fb5c17a82313', "\u3000People's fear erupted into riots,"),
 (38, 'b5dbce1cdbb53018', 'and the news raced across the UN amid'),
 (42, '11f5b4692c20b6c6', 'reckless rumors, stirring deeper unease.'),
 (42, '946c05dce0cb7fca', 'The New Federation, reshaped by the coup,'),
 (40, 'aef9ddf33f224956', 'sent troops to crush the riots - yet the'),
 (40, 'd141dd0d26f92c42', 'fear rooted deep in their hearts could'),
 (20, 'd3fbfe2f1ec30620', 'not be removed.'),
 (42, '4d9c47c527b96c60', '\u3000And the Second Break had changed the'),
 (40, 'c504f3ae1edef26b', 'Cross-Realm dividing Earth and space.'),
 (38, 'e571fab702ba967c', '\u3000Its power weakened the world over,'),
 (32, '995b446c8a4a639e', 'and Trapar grew in its place.'),
 (40, 'dc66a851b2f04113', 'With this, alien attacks and the war of'),
 (40, '782020c0a3c6decc', 'Earth and space dwellers raged on, and'),
 (40, 'e31c069eeee6ca81', 'Coralian antibodies stirred everywhere.'),
 (42,
  'ddc931ad58b8a79e',
 ...
 (40,
  '6486722a47fa44d2',
  '\u3000With the world in peril, those seeking\nits dominion and future began the final\nbattle')]
